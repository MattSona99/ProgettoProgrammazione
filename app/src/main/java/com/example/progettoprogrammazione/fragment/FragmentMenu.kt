...
class FragmentMenu : Fragment(), ProductClickListener, ProductUtils {
    ...
    override fun onCreateView(
        ...
        val layoutManagerBev = GridLayoutManager(context, 1)
        ...
        val layoutManagerAnt = GridLayoutManager(context, 1)
        ...
        val layoutManagerPri = GridLayoutManager(context, 1)
        ...
        val layoutManagerSec = GridLayoutManager(context, 1)
        ...
        val layoutManagerCon = GridLayoutManager(context, 1)
        ...
        val layoutManagerDol = GridLayoutManager(context, 1)
